...
fun TranslateProgressionRepository.getOrThrow(translateProgressionId: UUID) = findById(translateProgressionId)
    ?: throw NotFoundException("식별자에 대한 번역 진행 상황을 찾을 수 없습니다. id=$translateProgressionId")

interface TranslateProgressionRepository : Repository<TranslateProgression, UUID> {
